...
StatTranslator = {
	...
	(5 , 0)    : 'champ.magic_res',
	(5 , 2)    : 'champ.bonus_magic_res',
	(6 , 2)    : 'champ.bonus_move_speed',
	(7 , 0)    : 'champ.crit',
	(8 , 0)    : 'champ.crit_multi',
	(8 , 1)    : 'champ.crit_multi',
	(8 , 2)    : 'champ.crit_multi',
	(9 , 0)    : 'champ.cdr',
	(11, 0)    : 'champ.max_health',
	(11, 1)    : 'champ.base_health',
	(11, 2)    : 'champ.bonus_health',
	(12, 0)    : 'champ.health',
	(23, 0)    : 'champ.lethality',
	(24, 0)    : 'champ.lethality',
	(26, 0)    : 'champ.lethality',
	(26, 2)    : 'champ.lethality/100.0'
}
...
def extract_unit_info(folder):
	...
	for i, fname in enumerate(os.listdir(folder)):
		...
		if fname.startswith(('brush_', 'nexusblitz_', 'slime_', 'tft', 'preseason', 'test', 's5test', 'azirtowerclicker', 'sru_plantrespawnmarker')):
