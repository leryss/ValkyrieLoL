...
BOOST_PYTHON_MODULE(valkyrie) {
	...
	enum_<GameBuffType>("GameBuffType", "Game buff type (use this instead of buffs from spells.py)")
		...
		.value("CombatDebuff",      BuffTypeCombatDebuff)
		.value("SpellShield",       BuffTypeSpellShield)
		.value("Stun",              BuffTypeStun)
		.value("Invisibility",      BuffTypeInvisibility)
		.value("Silence",           BuffTypeSilence)
		.value("Taunt",             BuffTypeTaunt)
		.value("Polymorph",         BuffTypePolymorph)
		.value("Slow",              BuffTypeSlow)
		.value("Snare",             BuffTypeSnare)
		.value("Damage",            BuffTypeDamage)
		.value("Heal",              BuffTypeHeal)
		.value("Haste",             BuffTypeHaste)
		.value("SpellImmunity",     BuffTypeSpellImmunity)
		.value("PhysicalImmunity",  BuffTypePhysicalImmunity)
		.value("Invulnerability",   BuffTypeInvulnerability)
		.value("Sleep",             BuffTypeSleep)
		.value("NearSight",         BuffTypeNearSight)
		.value("Frenzy",            BuffTypeFrenzy)
		.value("Fear",              BuffTypeFear)
		.value("Charm",             BuffTypeCharm)
		.value("Poison",            BuffTypePoison)
		.value("Suppression",       BuffTypeSuppression)
		.value("Blind",             BuffTypeBlind)
		.value("Counter",           BuffTypeCounter)
		.value("Shred",             BuffTypeShred)
		.value("Flee",              BuffTypeFlee)
		.value("Knockup",           BuffTypeKnockup)
		.value("Knockback",         BuffTypeKnockback)
		.value("Disarm",            BuffTypeDisarm)
		;
	...
	class_<GameBuff>("Buff", "Contains data related to a buff on a champion")
		.def_readonly("type",                &GameBuff::type,        "[GameBuffType] Type of buff")
